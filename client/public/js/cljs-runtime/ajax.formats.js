...
var G__12380 = request;
var G__12381 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12380,G__12381) : ajax.formats.get_format.call(null,G__12380,G__12381));
} else {
...
return cljs.core.some((function (p1__12387_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12387_SHARP_);
}),accept);
});
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12392__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12396 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12396.cljs$core$IFn$_invoke$arity$1 ? fexpr__12396.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12396.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12398){
var map__12399 = p__12398;
var map__12399__$1 = cljs.core.__destructure_map(map__12399);
var request = map__12399__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12399__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12397_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12397_SHARP_);
