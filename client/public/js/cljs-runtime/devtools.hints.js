...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12712__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12712__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12712__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5802__auto___12770 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12770)){
var seen_errors_12771 = temp__5802__auto___12770;
if(cljs.core.truth_(seen_errors_12771.has(self))){
} else {
seen_errors_12771.add(self);

var temp__5804__auto___12772 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12772)){
var sense_12773 = temp__5804__auto___12772;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12773)].join(''));
} else {
}
}
} else {
