...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15046 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15046(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15047 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15047(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15052 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15052(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15057 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15057(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15061 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15061(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15062 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15062(reader);
}
});
...
var G__15103 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15104 = s.append(c);
c = G__15103;
s = G__15104;
continue;
}
