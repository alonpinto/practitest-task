...
var o12760 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12760["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12761 = temp__5802__auto____$1;
return (o12761["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12056__auto__ = f;
return (o__12056__auto__["toString"]).call(o__12056__auto__);
} else {
return "";
}
}catch (e12764){var _ = e12764;
return "";
}});
...
try{var o__12056__auto___12962 = t;
(o__12056__auto___12962["cljs$lang$ctorPrWriter"]).call(o__12056__auto___12962,t,writer);
}catch (e12774){var __12963 = e12774;
}
...
var char_code = (function (){var o__12056__auto__ = (new String(char$));
return (o__12056__auto__["charCodeAt"]).call(o__12056__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12056__auto__ = String;
return (o__12056__auto__["fromCharCode"]).call(o__12056__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12781 = num_code;
switch (G__12781) {
case (1):
return (185);
...
var o__12056__auto__ = String;
return (o__12056__auto__["fromCharCode"]).call(o__12056__auto__,superscript_code);
});
/**
...
}catch (e12785){var _e__12065__auto__ = e12785;
return false;
}})())){
...
var vec__12790 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12790,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o12793 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12793["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12794 = temp__5802__auto____$1;
return (o12794["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12804){
var vec__12805 = p__12804;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12805,(0),null);
...
var G__13019 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13020 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13019;
remaining_tokens = G__13020;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12796){
var G__12797 = cljs.core.first(seq12796);
var seq12796__$1 = cljs.core.next(seq12796);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12797,seq12796__$1);
}));
...
var vec__12815 = cljs.core.split_with((function (p1__12813_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12813_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12815,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12815,(1),null);
...
var vec__12827 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12827,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12827,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13031 = cljs.core.rest(remaining_tokens);
var G__13032 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13031;
name_tokens = G__13032;
continue;
} else {
...
var vec__12832 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12832,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12832,(1),null);
var vec__12835 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12835,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12835,(1),null);
var vec__12838 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(3),null);
...
var vec__12849 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12849,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12849,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12849,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12849,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12849,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12849,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12854 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12854,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12854,(1),null);
var vec__12857 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12860 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12860) : devtools.munging.parse_fn_info_deep.call(null,G__12860));
})()));
}
} else {
return fn_info;
...
var G__13045 = (arity + (1));
var G__13046 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12873){
var vec__12874 = p__12873;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12874,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12874,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12889_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12889_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12890_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12890_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___13055 = arguments.length;
var i__5770__auto___13056 = (0);
while(true){
if((i__5770__auto___13056 < len__5769__auto___13055)){
args__5775__auto__.push((arguments[i__5770__auto___13056]));

var G__13057 = (i__5770__auto___13056 + (1));
i__5770__auto___13056 = G__13057;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12895){
var vec__12896 = p__12895;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12896,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12892){
var G__12893 = cljs.core.first(seq12892);
var seq12892__$1 = cljs.core.next(seq12892);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12893,seq12892__$1);
}));
...
var map__12907 = options;
var map__12907__$1 = cljs.core.__destructure_map(map__12907);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12907__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12907__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12907__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12907__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12908 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12908,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12908,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12908,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12908,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12908,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12908,(5),null);
...
var o__12056__auto__ = f;
return (o__12056__auto__["getBasis"]).call(o__12056__auto__);
});
/**
...
}catch (e12913){var _e__12065__auto__ = e12913;
...
var G__13069 = (obj[cljs.core.first(path)]);
var G__13070 = cljs.core.rest(path);
obj = G__13069;
path = G__13070;
continue;
} else {
...
var _STAR_ = (function (accum,p__12930){
var vec__12931 = p__12930;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12931,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12931,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12941){
var vec__12942 = p__12941;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12942,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12942,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12942,(2),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12945_SHARP_){
return (obj[cljs.core.first(p1__12945_SHARP_)]);
}),sorted_matches);
