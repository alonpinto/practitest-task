...
var len__5769__auto___13110 = arguments.length;
var i__5770__auto___13111 = (0);
while(true){
if((i__5770__auto___13111 < len__5769__auto___13110)){
args__5775__auto__.push((arguments[i__5770__auto___13111]));

var G__13112 = (i__5770__auto___13111 + (1));
i__5770__auto___13111 = G__13112;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13047){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13048,G__13049,seq13047__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13063_SHARP_){
return (!((cljs.core.meta(p1__13063_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13079__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13080){var _e__12065__auto__ = e13080;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e13082){var _e__12065__auto__ = e13082;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13089 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13090 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13090);

try{var map__13091 = opts;
var map__13091__$1 = cljs.core.__destructure_map(map__13091);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13091__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13089);
}});
...
var temp__5802__auto___13134 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13134)){
var managed_print_level_13135 = temp__5802__auto___13134;
var _STAR_print_level_STAR__orig_val__13102_13136 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13103_13137 = managed_print_level_13135;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13103_13137);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13094_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13094_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13102_13136);
}} else {
job_fn();
}
