...
var G__23485 = o;
(G__23485[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__23486 = o;
(G__23486[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__23488 = props;
var G__23488__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23488,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23488);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23488__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__23489){
var map__23490 = p__23489;
var map__23490__$1 = cljs.core.__destructure_map(map__23490);
var props = map__23490__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23490__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__23491){
var map__23492 = p__23491;
var map__23492__$1 = cljs.core.__destructure_map(map__23492);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23492__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__23494 = jsprops;
(G__23494["defaultValue"] = value);

(G__23494["onChange"] = (function (p1__23493_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__23493_SHARP_);
}));
...
var vec__23496 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23496,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23496,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23496,(2),null);
...
var jsprops = ({"argv": v});
var temp__5808__auto___23525 = reagent.impl.template.key_from_vec(v);
if((temp__5808__auto___23525 == null)){
} else {
var key_23526 = temp__5808__auto___23525;
(jsprops["key"] = key_23526);
}
...
var temp__5808__auto___23527 = reagent.impl.template.key_from_vec(argv);
if((temp__5808__auto___23527 == null)){
} else {
var key_23528 = temp__5808__auto___23527;
reagent.impl.template.oset(jsprops,"key",key_23528);
}
...
var G__23500 = reagent.impl.template.__GT_NativeWrapper();
(G__23500["name"] = c);
...
var G__23501 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__23501) : reagent.impl.template.as_element.call(null,G__23501));
} else {
...
var len__5769__auto___23534 = arguments.length;
var i__5770__auto___23535 = (0);
while(true){
if((i__5770__auto___23535 < len__5769__auto___23534)){
args__5775__auto__.push((arguments[i__5770__auto___23535]));

var G__23536 = (i__5770__auto___23535 + (1));
i__5770__auto___23535 = G__23536;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23504){
var G__23505 = cljs.core.first(seq23504);
var seq23504__$1 = cljs.core.next(seq23504);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23505,seq23504__$1);
}));
...
break;
default:
var G__23538 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__23538;
continue;
...
var n__5636__auto___23539 = a.length;
var i_23540 = (0);
while(true){
if((i_23540 < n__5636__auto___23539)){
(a[i_23540] = reagent.impl.template.as_element((a[i_23540])));

var G__23541 = (i_23540 + (1));
i_23540 = G__23541;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5636__auto___23542 = a.length;
var i_23543 = (0);
while(true){
if((i_23543 < n__5636__auto___23542)){
var val_23544 = (a[i_23543]);
if(((cljs.core.vector_QMARK_(val_23544)) && ((reagent.impl.template.key_from_vec(val_23544) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_23543] = reagent.impl.template.as_element(val_23544));

var G__23546 = (i_23543 + (1));
i_23543 = G__23546;
continue;
} else {
}
...
var ctx = ({});
var vec__23508 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23508,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23508,(1),null);
...
var G__23511 = (cljs.core.count(argv) - first_child);
switch (G__23511) {
case (0):
