...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_12161 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_12161(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_12162 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_12162(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_12163 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_12163(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_12164 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_12164(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_12165 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_12165(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_12166 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_12166(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_12171 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_12171(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_12173 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_12173(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_12174 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_12174(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_12179 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_12179(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k12147,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k12147,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__12152){
var vec__12153 = p__12152;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12153,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12153,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__12146){
var self__ = this;
var G__12146__$1 = this;
return (new cljs.core.RecordIter((0),G__12146__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this12148,other12149){
var self__ = this;
var this12148__$1 = this;
return (((!((other12149 == null)))) && ((((this12148__$1.constructor === other12149.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12148__$1.status,other12149.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12148__$1.body,other12149.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12148__$1.status_text,other12149.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12148__$1.headers,other12149.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12148__$1.was_aborted,other12149.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12148__$1.__extmap,other12149.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k12147){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k12147);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__12146){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__12157 = cljs.core.keyword_identical_QMARK_;
var expr__12158 = k__5352__auto__;
if(cljs.core.truth_((pred__12157.cljs$core$IFn$_invoke$arity$2 ? pred__12157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__12158) : pred__12157.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__12158)))){
return (new ajax.protocols.Response(G__12146,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12157.cljs$core$IFn$_invoke$arity$2 ? pred__12157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__12158) : pred__12157.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__12158)))){
return (new ajax.protocols.Response(self__.status,G__12146,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12157.cljs$core$IFn$_invoke$arity$2 ? pred__12157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__12158) : pred__12157.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__12158)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__12146,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12157.cljs$core$IFn$_invoke$arity$2 ? pred__12157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__12158) : pred__12157.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__12158)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__12146,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12157.cljs$core$IFn$_invoke$arity$2 ? pred__12157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__12158) : pred__12157.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__12158)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__12146,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__12146),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__12146){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__12146,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__12150){
var extmap__5385__auto__ = (function (){var G__12160 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__12150,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__12150)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__12160);
} else {
return G__12160;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__12150),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__12150),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__12150),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__12150),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__12150),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
