...
var G__13039 = devtools.prefs.pref(v);
v = G__13039;
continue;
} else {
return v;
...
}catch (e12969){var _e__12065__auto__ = e12969;
return false;
}})();
...
}catch (e12974){var _e__12065__auto__ = e12974;
return false;
}})();
...
}catch (e12979){var _e__12065__auto__ = e12979;
return false;
}}
}
});
...
var vec__13016 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13016,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13016,(1),null);
...
return cljs.core.some((function (p1__13024_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13024_SHARP_);
}),template);
});
