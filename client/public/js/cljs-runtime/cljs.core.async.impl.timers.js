...
var i_17653 = (0);
while(true){
if((i_17653 < arr.length)){
(arr[i_17653] = null);

var G__17654 = (i_17653 + (1));
i_17653 = G__17654;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17675 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17675[i]));
} else {
x__$2.forward.push((((i < links_17675.length))?(links_17675[i]):null));
}

if((i < links_17675.length)){
(links_17675[i] = x__$2);
} else {
links_17675.push(x__$2);
}
...
var i_17680 = (0);
while(true){
if((i_17680 <= self__.level)){
var links_17681 = (update[i_17680]).forward;
if((x__$1 === (((i_17680 < links_17681.length))?(links_17681[i_17680]):null))){
(links_17681[i_17680] = (x__$1.forward[i_17680]));

var G__17683 = (i_17680 + (1));
i_17680 = G__17683;
continue;
} else {
var G__17684 = (i_17680 + (1));
i_17680 = G__17684;
continue;
}
} else {
